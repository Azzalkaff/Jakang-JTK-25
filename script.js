...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const ootdForm = document.getElementById('upload-form');
    const ootdNameInput = document.getElementById('ootd-name');
    const ootdFileInput = document.getElementById('ootd-file');
    ...
    async function fetchOotdPosts() {
        ...
        if (error) {
            ...
            if (ootdGrid)
                ootdGrid.innerHTML = `<p class="text-red-500 col-span-full text-center">Gagal memuat data dari server: ${error.message}</p>`;
            return;
        }
        if (ootdGrid) {
    ...
    const excForm = document.getElementById('exchange-form');
    const excName = document.getElementById('exc-name');
    const excHave = document.getElementById('exc-have');
    const excWant = document.getElementById('exc-want');
    const excContact = document.getElementById('exc-contact');
    const excSubmitBtn = document.getElementById('exc-submit-btn');
